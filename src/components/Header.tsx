...
export const Header = () => {
  return (
    <div className="sticky top-0 w-full h-fit bg-primary-300">
      <div className="w-full h-fit flex justify-between items-center bg-primary-300 text-ttt-200">
      ...
      <div className="flex w-full h-fit py-4 justify-between px-4 bg-primary-300 text-ttt-200">
